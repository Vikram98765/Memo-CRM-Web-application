...
@section('content')
 ...
 <div class="card shadow mb-4">
     ...
     <div class="card-body">
        <form class="user" method="post" action="{{Route('save_customers')}}">
            @csrf
            @method('post')
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user"
                        id="cumtomername" placeholder="Cumtomer Name" name="customername">
                        @error('cumtomername')
                        <span class="d-block fs-6 text-danger mt-2"> {{ $message }} </span>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user"
                        id="gstin" placeholder="GSTIN NO" name="gstin">
                        @error('gstin')
                        <span class="d-block fs-6 text-danger mt-2"> {{ $message }} </span>
                    @enderror
                </div>
